...
try:
    def RTLData():
        ...
        d.text(ScreenWidth/2,0,"N",size=8,color="green")
        d.text(ScreenWidth/2,ScreenHeight,"S",size=8,color="green")
        d.text(ScreenWidth,ScreenHeight/2,"E",size=8,color="green")
        d.text(0,ScreenHeight/2,"W",size=8,color="green")
